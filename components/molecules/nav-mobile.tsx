  ...
  return (
    <nav className='w-full space-y-4 mb-4'>
      <div className='bg-[#3f1b26] flex flex-col gap-4 items-center py-6'>
        <Link
          className='text-sm font-light text-secondary hover:text-white hover:font-medium'
        ...
        <Link
          ...
          className="text-sm text-secondary hover:text-white font-light flex justify-center items-center gap-2  text-nowrap hover:font-medium px-1 duration-200"
        >
