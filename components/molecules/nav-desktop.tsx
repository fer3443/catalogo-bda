  ...
  return (
    <nav className="bg-[#3f1b26] w-full py-2 px-6 flex justify-between items-center mb-4">
      <div className="flex gap-2 items-center">
        <ImLocation2/>
        <Link
          className='text-base font-light text-secondary hover:text-white'
        ...
        <Link
          ...
          className="text-base font-light flex justify-center items-center gap-2 text-nowrap hover:font-medium px-1 duration-200 text-secondary hover:text-white"
        >
